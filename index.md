...
to read and write single files to an archive. These files return
connections, which can be passed to any R interface which can take a
connection. Most base R file system functions use connections, as well
...
[`file_write()`](https://archive.r-lib.org/reference/file_connections.md)
returns a connection to filtered by one or more compressions or
encodings.
[`file_read()`](https://archive.r-lib.org/reference/file_connections.md)
